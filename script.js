...
const videolist = {
  Hi: "./assets/video2.mp4",
  "How are you": "./assets/video3.mp4",
  "What is insulin": "./assets/video1.mp4",
  "Can I go to school": "./assets/video2.mp4",
  "Can I play with other children": "./assets/video3.mp4",
};
...
function getvideo(datavalue) {
  if (videolist[datavalue] == undefined) {
    return "./assets/Diabetes Besties.mp4";
  } else {
